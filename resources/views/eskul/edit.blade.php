                ...
                <div class="card-body">
                    <form action="{{ route('eskul.update', $eskul->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('eskul') is-invalid @enderror" name="eskul" value="{{ $eskul->eskul }}" placeholder="nama eskul" required>
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ $fasilitas->image }}"></input>
                            @error('image')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
